...
namespace StartupProject.Core.Domain
{
    ...
    public partial class CommonHelper
    {
        ...
        /// </summary>
        private static readonly string[] skipFixedColumns = new string[] { "CreatedOn", "CreatedBy" };
        ...
        public static string ConvertEnum(string str)
        {
            ...
            foreach (var c in str)
                if (c.ToString() != c.ToString().ToLower(CultureInfo.CurrentCulture))
                    result += " " + c.ToString();
                else
                    result += c.ToString();
        ...
        public static object GetPrivateFieldValue(object target, string fieldName)
        {
            //if (target == null)
            //{
            //    throw new ArgumentNullException("The assignment target cannot be null.");
            //}

            if (string.IsNullOrEmpty(fieldName))
            {
                throw new ArgumentException("The field name cannot be null or empty.");
            }
        ...
        {
            return FormatAmountWithProperDecimal(Convert.ToDecimal(value), decimalPlaces);
        }

        /// <summary>
        /// Format with proper decimal, like if decimal is included in the value or not
        /// </summary>
        public static string FormatAmountWithProperDecimal(decimal value, int places)
        {
            return value.ToString("N" + places);
        }
        ...
        [Obsolete(" It's gonna slow you down more than you think https://jeanpaul.cloud/2018/07/30/automapper-vs-quickmapper-vs-reflection/ .No longer recommended for use. will be removed in a future.")]
        public static void CopyObject<T>(object sourceObject, ref T destObject, params string[] skippingNames)
        {
            ...
            foreach (PropertyInfo p in sourceType.GetProperties())
            {
                ...
                if (destObj.PropertyType.IsClass && !destObj.PropertyType.FullName.Equals("System.String", StringComparison.Ordinal))
                    continue;
